...
client.connect_signal("request::titlebars", function(c)
		...
		{
			{
				tabbed_misc.titlebar_indicator(c, {
					...
					fg_color_focus = beautiful.taglist,
					layout = wibox.layout.flex.horizontal,
					widget_template = {
						{
							{
	...
	client.connect_signal("focus", function(c)
		...
		if c.requests_no_titlebar ~= true then
			awful.titlebar(c, { position = "left",   bg = beautiful.border_focus, size = beautiful.border_size })
			awful.titlebar(c, { position = "right",  bg = beautiful.border_focus, size = beautiful.border_size })
			awful.titlebar(c, { position = "top",    size = 24 }).widget.bg = beautiful.border_focus 
			awful.titlebar(c, { position = "bottom", size = bs }).widget.bg = beautiful.border_focus
		end
	end)
	...
	client.connect_signal("unfocus", function(c)
		local bs = tabcheck(c)
		if c.requests_no_titlebar ~= true then
			awful.titlebar(c, { position = "left",   bg = beautiful.border_normal, size = beautiful.border_size })
			awful.titlebar(c, { position = "right",  bg = beautiful.border_normal, size = beautiful.border_size })
			awful.titlebar(c, { position = "top",    size = 24 }).widget.bg = beautiful.border_normal 
			awful.titlebar(c, { position = "bottom", size = bs }).widget.bg = beautiful.border_normal
		end
	end)
