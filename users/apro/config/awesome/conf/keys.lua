...
--- Legacy layout switching keybind, obsolete for me due to the FCK layout
...
--	   These can mess with DreymaR's extend layer quite a bit so I keep them disabled
--     NOTE: Obsolete due to the FCK layout
--
