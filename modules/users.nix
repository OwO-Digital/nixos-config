	...
	options.modules.users = mkOption {
		...
		default = {
			apro = {
				...
				# modules = let
				# 	nurNoPkgs = import (fetchTarball {
				# 		url = "https://github.com/nix-community/NUR/archive/master.tar.gz";
				# 		sha256 = "0381dbgis9jk07w6whq809kihyc3dhibig4i86xq2bh9y9v67lb3";
				# 	}); in
				# 	[ nurNoPkgs.repos.splintah.hmModules.mpdscribble ];

				fc = {
					# `fonts` takes a list of packages
					fonts = with pkgs; [ roboto twemoji-color-font noto-fonts noto-fonts-cjk-sans noto-fonts-emoji-blob-bin material-design-icons ];
